...
class Delete():
    def __init__(self,master):
        ...
        self.menu = Menu(self.master)
        self.file_menu = Menu(self.menu,tearoff = 0)
        self.file_menu.add_command(label = "Delete", command = self.deletefile)
        self.file_menu.add_command(label="Exit",accelerator= 'Alt+F4',command = self.exitmenu)
        self.menu.add_cascade(label = "File",menu=self.file_menu)
...
class Createl():
    def __init__(self,master):
        ...
        self.menu = Menu(self.master)
        self.file_menu = Menu(self.menu,tearoff = 0)
        self.file_menu.add_command(label = "Insert",command = self.ins)
        self.file_menu.add_command(label = "Cancel", command = self.cans)
        self.file_menu.add_command(label = "Clear", command = self.clearfun)
        self.file_menu.add_command(label = "Ok" , command = self.okb)
        self.file_menu.add_command(label="Exit",accelerator= 'Alt+F4',command = self.exitmenu)
        self.menu.add_cascade(label = "File",menu=self.file_menu)
